...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
  ...
  <div class="accordion-item">
    ...
    <h2 class="accordion-header" id="flush-headingFour">
      <button class="accordion-button collapsed accordionbutton familyprescriptionbtn"
          style="display:flow"
        type="button" 
 ...
 <div class="medic-his-btn mt-3 buttons-container" style="display:flex;justify-content:space-evenly">
    ...
    <script>
        ...
        $(".familyprescriptionbtn").on("click", function () {
            window.location.href = "FamilyPrescription.aspx";
        });
