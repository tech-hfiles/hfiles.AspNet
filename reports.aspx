                                        ...
                                        <div class="card text-start px-3 h-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="Whatappicon d-flex align-items-center justify-content-between">
                                                    ...
                                                    <asp:LinkButton Text="text" ID="lbtnremove" OnClick="lbtnremove_Click" Visible='<%# hfiles.DAL.validateInt(Session["UserId"]) == hfiles.DAL.validateInt(Eval("UserId").ToString()) ? true : false  %>' runat="server" CommandArgument='<%# Eval("Id")%>'>
