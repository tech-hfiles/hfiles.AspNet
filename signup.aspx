...
<head>
    ...
    <script src=" <%= ResolveUrl("~/alert/dist/sweetalert-dev.js") %>"></script>
    <link rel="stylesheet" href=" <%= ResolveUrl("~/alert/dist/sweetalert.css") %>" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"
        integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <title>H Files | Sign Up</title>
</head>
<body>
    <form class="container h-100 signin-main" runat="server">
        ...
        <img class="triangle-bottom-right" src="<%= ResolveUrl("~/assets/blue-trangle-bottom-1.png") %>" alt="" />
        <img class="triangle-bottom-left" src="<%= ResolveUrl("~/assets/blue-trangle-1.png") %>" alt="" />
        ...
        <a href="<%= ResolveUrl("~/login.aspx") %>"> <img class="triangle-top-right-cancel"   src="<%= ResolveUrl("~/assets/cancel-icon.png") %>" alt="" /></a>
    </form>
