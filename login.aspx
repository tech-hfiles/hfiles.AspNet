    ...
    <div class="container-fluid">
        <form class="row h-100 align-ceter" runat="server" style="display: flex; flex-wrap: wrap;">
            ...
            <div class="col-sm-12 col-lg-6 inner-main" id="right-side-bar" style="/*overflow-y: auto; */ height: 100vh !important; /*padding: 20px; */">
                <div class="d-flex align-items-center justify-content-center inner-body custom-padding">
                    <div class="text-center">
                        ...
                        <div style="position: relative; width: 350px;">
                            <div class="form-control" id="inputWrapper"
                                style="border-radius: 20px; display: flex; padding: 0; margin-top: 7px; margin-bottom: 7px; width: 100%; height: 50px; align-items: center; overflow: hidden; border: 1px solid #ccc;">

                                <!-- Dropdown for email or contact selection -->
                                <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-select" EnableViewState="true" onchange="updateDialingCode()" Style="border: none !important; padding-left: 12px !important; width: 128px !important; height: 49px !important; position: absolute; left: 2px; top: 1px;">
                                </asp:DropDownList>
                                ...
                                <asp:TextBox ID="emailTextBox" CssClass="w-95 login-input" required TextMode="SingleLine"
                                    ...
                                    Style="border: none !important; padding-left: 39px !important; width: 100%; height: 48px; padding-right: 10px; padding-bottom: 4px;">
                                </asp:TextBox>
                            </div>
                        </div>
