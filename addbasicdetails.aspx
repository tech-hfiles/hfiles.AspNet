                        ...
                        <div class="col-md-4 col-12 col-lg-4 col-xl-4 d-flex align-items-start mt-lg-5 justify-content-center">
                            <div class="row signin-form form-group has-search">
                                ...
                                <div class="col-12">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="rfvstateTextbox" ControlToValidate="stateTextBox" ValidationGroup="updateProfile" Display="Dynamic" ErrorMessage="Please Select State" CssClass=""></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-12 mb-lg-5">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="rfvcityTextBox" ControlToValidate="cityTextBox" ValidationGroup="updateProfile" Display="Dynamic" ErrorMessage="Please Select City" CssClass=""></asp:RequiredFieldValidator>
                                </div>
                            </div>
