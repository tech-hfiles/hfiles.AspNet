            ...
            <div>
                <header class="header">
                    ...
                    <%--<button class="hamburger" id="menu-toggle" type="button">☰</button>--%>
                                    <%--<button class="hamburger" id="menu-toggle" type="button">&#9776;</button>--%>
                     <a href="/login.aspx" class="header-signin">
   <div class="signup">
       <p>Sign In</p>
   </div>
 </a>
                    ...
                    <nav id="nav-menu" class="nav" >
                        <ul class="nav-links">
                            ...
                            <li> <a href="https://articles.hfiles.in/">Article</a> 
<!-- <iframe src="https://articles.hfiles.in" width="100%" height="1000px" style="border:none;">Article</iframe> -->
</li>
                            <li>
                                <a href="/login.aspx" >
                                  <div class="signup">
                ...
                <section class="healthcare-section" style="background-image:url('https://hfiles.in/wp-content/uploads/2023/03/hero-bh-pattern2.jpg')">
                    ...
                    <div class="main-heroheader">
                        ...
                        <div class="text-content" >
                            ...
                            <div class="badges">
                                <img loading="lazy" decoding="async"  src="/journal-page-images/article/SecureStorageAssured.png" alt="Secure Storage Assured" class="badge"/>
                                <img loading="lazy" decoding="async"  src="/journal-page-images/article/AyushmanBharat.png" alt="Ayushman Bharat" class="badge"/>
                            </div>
                        </div>
    ...
    <section class="whyuse-section" id="why">
        <div class="main_second_slide">
                ...
                <div class="whyuse-header">
                 ...
                 <div class="secound_slide_image">
                            <img loading="lazy" decoding="async"  class="whyuse-mockup" src="journal-page-images/article/pixelcut-export-mockup.png" alt="Why Use Health Files"  />
                 </div>
                 ...
                 <div class="whyuse-container">
                    ...
                    <div class="whyuse-features" >
                        <div class="feature-card">
                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/secure-storage.png" alt="Secure Storage">
                            <h3>Secure Document Storage</h3>
                            <p>Your data is secured and safely stored on a cloud storage</p>
                        </div>

                        <div class="feature-card">
                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/family-health.png" alt="Family Management">
                    ...
                    <div class="whyuse-features" >
                        <div class="feature-card">
                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/easy-access.png" alt="Easy Access">
                            <h3>Easy Access and Sharing</h3>
                            <p>View, download, or share your medical files anytime and anywhere</p>
                        </div>

                        <div class="feature-card">
                             <img loading="lazy" decoding="async"  src="/journal-page-images/article/track-history.png" alt="Track History">
                    ...
                    <div class="whyuse-features" >
                        <div class="feature-card">
                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/time-saving.png" alt="Time-Saving">
                        ...
                        <div class="feature-card">
                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/abha-id.png" alt="ABHA ID">
        ...
        <div class="content">
            <div class="video-container">
             ...
             <div class="videodesktop">
                     <video id="myVideo" class="desktop_final_video" controls poster="video_desktopview.jpeg">
                ...
                <div class="videomobile">
                     <video id="myVideo1" class="mobile_final_video" controls poster="video_mobileView.jpeg">
           ...
           <section class="abha-section">
               <div class="main_abha_card">
                    ...
                    <div class="abha-image-container1">
                        <img loading="lazy" decoding="async"  src="https://hfiles.in/wp-content/uploads/2022/12/user-profile-screen.png" 
                             alt="ABHA Health ID by Health Files" class="abha-card-image">
                    </div>
                ...
                <div class="just_for_desktop">
                    ...
                    <div class="main_abha_idcard">
                        ...
                        <div class="floating-card signup-card">
                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/signupabhaid.png" 
                             alt="ABHA Health ID by Health Files"  class="signup-icon" >
                        </div>
     ...
     <button class="abha-button" onclick="window.open('CreateAbhaCard.aspx', '_blank')"><span>Create your ABHA ID</span></button>
  </div>
                                                    <%--<img loading="lazy" decoding="async"  src="journal-page-images/article/comingsoon.png" 
                             alt="ABHA Health ID by Health Files"  />--%>
                          </div>
                        </div>

                         <div class="ayushman-badge">
                         <img loading="lazy" decoding="async"  src="/journal-page-images/article/AyushmanBharat.png" 
                             alt="ABHA Health ID by Health Files"  class="ayushman-icon">
                         </div>
                    </div>
...
<%--                                                    <div class="solution_image">--%>
                                                        <img loading="lazy" decoding="async"  class="main_solution_image solution_image" src="/journal-page-images/article/personalized.png" alt="Personalized Health Solutions by Health Files"/>
                                                    <%--</div>--%>
                                                    </div>
                     ...
                     <div class="main_about_us">
                       <div class="about-content">
                           <%--<div class="about-image">--%>
                               ...
                               <img loading="lazy" decoding="async"  class="desktop_image_aboutus" src="/journal-page-images/article/about_us_short.png" />
                        ...
                        <section class="recognized-section">
                            <div class="main-recognized">
                                <div class="image-wrapper1">
                                    ...
                                    <img loading="lazy" decoding="async"  src="/journal-page-images/article/Recognized.jpeg" alt="Image 1">
                                </div>

                                <div class="image-wrapper2">
                                    <h3>Active Integrator</h3>
                                    <div class="image-flex">
                                        <img loading="lazy" decoding="async"  src="/journal-page-images/article/Active.jpeg" alt="Image 3">
                                        <img loading="lazy" decoding="async"  src="/journal-page-images/article/Active2.jpeg" alt="Image 4">
                                    </div>
                                </div>
                            </div>
                        </section>
       ...
       <img loading="lazy" decoding="async"  class="article_image" src="/journal-page-images/article/article44.jpeg" alt="Article Image" /> 
   <div class="article_content">
<a href="https://articles.hfiles.in/oral-hygiene-tips-for-seniors-what-you-need-to-know/" style=" color:inherit; text-decoration:none;">
         <div class="article_title">
             <h1>Oral Hygiene Tips for Seniors: What You Need</h1>
             <p>Oral health isn't just about sparkling teeth-it's your ticket to staying healthy and feeling. . . </p>
          </div>
         ...
         <p class="readmore">Read more . . .</p>
                       ...
                       <div class="article_card">
                              ...
                              <img loading="lazy" decoding="async"  class="article_image" src="/journal-page-images/article/article22.jpg" alt="Article Image" />
                           <div class="article_content">
 <a href="https://articles.hfiles.in/7-healthy-habits-that-can-improveyour-digestion/" style=" color:inherit; text-decoration:none;">
                               <div class="article_title">
                                   <h1>7 healthy Habits That Can Improve Your Digestion</h1>
                       ...
                       <%------------ card three -----------%>
                        ...
                        <div class="article_card">
                              ...
                              <img loading="lazy" decoding="async"  class="article_image" src="/journal-page-images/article/article33.jpeg" alt="Article Image" />
                           <div class="article_content">

 <a href="https://articles.hfiles.in/oral-hygiene-tips-for-seniors-what-you-need-to-know/" style=" color:inherit; text-decoration:none;">
                               <div class="article_title">
                                   <h1>What Science Says About Feeding Animals...</h1>
 <p> As pet parents, we all want the best for our furry (or feathered or scaly) family members. But. . . </p>
                                </div>
                    ...
                    <div class="main_talk_to_us">
                        ...
                        <div class="talkus_icon_row">
                            ...
                            <div class="giveus_call">
                               <img loading="lazy" decoding="async"  src="/journal-page-images/article/phone-icon.png" alt="call to health files" />
                         ...
                         <%------------- second icon --------%>
                             ...
                             <div class="giveus_call">
                                <img loading="lazy" decoding="async"  src="/journal-page-images/article/email-icon.png" alt="mail to health files" />
                         ...
                         <%------------- third icon --------%>
                             ...
                             <div class="giveus_call">
                                <img loading="lazy" decoding="async"  src="/journal-page-images/article/whatsapp-icon.png" alt="call to health files" />

                                 <h2>WhatsApp us</h2>
                                  <a href="https://api.whatsapp.com/send?phone=919978043453&text=Hi" target="_blank"><p>+91 9978043453</p></a>
                             </div>
                     ...
                     <section class="handshake_section">
                         <div class="main_handshake">
                                ...
                                <div class="handshake1">
                                            ...
                                            <img loading="lazy" decoding="async"  src="/journal-page-images/article/landing-handshake.png" alt="Health Files Logo" />
                                            ...
                                            <div class="handshakecontent">
                                             ...
                                             <button class="gat_in_touch" onclick="window.open('https://mail.google.com/mail/?view=cm&fs=1&to=contact@hfiles.in&su=Inquiry&body=Hello, I have a question...', '_blank')"><span>GET IN TOUCH</span></button>
                                            </div>
                                </div>
             ...
             <section class="footer_section">
                <div class="main_footer">
                    ...
                    <div class="logo_section">
                        <img loading="lazy" decoding="async"  src="https://hfiles.in/wp-content/uploads/2022/11/hfiles.png" alt="hfiles logo" class="footer-logo" />
